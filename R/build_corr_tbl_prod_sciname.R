...
build_corr_tbl_prod_sciname <- function(
  ...
  prod_sciname_corrections <- tribble(
    ...
    "astacopsis franklinii",                "parastacidae",               "adjust_to_fb_slb", "FIXIT: Temporary change to family - remove once species is added to rfishbase data version (FAO 2025 uses rfishbase latest version 24.07)",
    ...
    "caspialosa",                           "alosa spp",                  "adjust_to_fb_slb", "unaccepted genus name, the genus is listed in FB synonym table but not a record with only the genus on its own",

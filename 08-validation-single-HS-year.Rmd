...
inputs_dir <- file.path("/Users/theamarks/Documents/UW-SAFS/ARTIS/data/model_inputs_2.0_FAO")
db_folder <- file.path("/Users/theamarks/Documents/UW-SAFS/ARTIS/data/outputs_2.0_FAO")
attribute_dir <- file.path(db_folder, "sql_database")
...
sciname <- fread(file.path(attribute_dir, "sciname.csv"), data.table = FALSE)

---
title: "ARTIS v1.2.0 Data Validation"
...
db_folder <- "/Users/theamarks/Documents/UW-SAFS/ARTIS/data/outputs_1.2.0_SAU_2025-11-10"
...
artis_ds <- arrow::open_dataset(
    file.path(
        db_folder, 
        "outputs_combined", 
        "ARTIS_v1.2.0_trade_SAU_mid_all_HS_yrs_2025-11-12.parquet"))
...
artis_ds <- arrow::open_dataset(
    file.path(
        db_folder, 
        "outputs_combined", 
        "ARTIS_v1.2.0_consumption_SAU_mid_all_HS_yrs_2025-11-12.parquet"))
...
prod <- fread(file.path(db_folder, "attribute_tables", "prod_sau.csv"))
baci <- fread(file.path(db_folder, "attribute_tables", "baci.csv")) 

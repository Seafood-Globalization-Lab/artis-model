...
if(dir.exists(outdir) & manual_mode == FALSE) {
...
if (dir.exists(outdir_quadprog) & manual_mode == FALSE) {
...
# Creating the sub folder for all country-level solutions generated by the python
# solver quadprog. Will delete folder if it already exists
if (dir.exists(outdir_cvxopt) & manual_mode == FALSE) {
...
# if it already exists
if(dir.exists(outdir_snet) & manual_mode == FALSE) {

...
artis_ds <- arrow::open_dataset(file.path(db_folder, "datasets", paste("ARTIS_", db_version, "_trade_FAO_mid_all_HS_yrs_", db_date, ".parquet", sep = "")))
...
baci_check <- artis_hs_summary %>%
  ...
  full_join(baci %>%
              filter(exporter_iso3c != "NEI",
                     # Temporarily remove Southern African Customs Union until
